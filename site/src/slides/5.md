...
For introverts, freelancing might kind of suck. Understand that at probably 20% of your time as a developer, no matter if you're an employee or freelance, is going to be spent talking to nontechnical people.

For extroverts, freelancing might be pretty sweet - but remember that being a freelancer isn't all about shmoozing and talking to people all the time. You need to, you know, do some actual web development once in a while. And you need to be good at it, or otherwise people won't hire you.

--------------------------------------------------------------------------------

# Pricing yourself & estimating
...
In either case, you need to **get good at estimating**. The only way to do that is to **complete lots of projects**, and think about how long it takes you to do each part of a project.

> _For reference, my current rate is $60/hour, with discounts for larger projects. I'm pretty darn cheap. It's not uncommon for solid, experienced freelancers to charge $150/hr._
...
**Landing pages and Marketing sites** - pages with one or two sections. Mostly consist of links to other sites.
