...
**Heads up** - we have a little less time to complete the class this year, because we don't want to conflict with CU finals. This means that it'd be good for us to have 2 make-up sessions at some point during the semester. More info on that later.
...
My dedicated in-person office hours are 2 hours before class - 5:30pm-7:30pm, Mondays and Wednesdays, here at Spark. My office is the one next to the Bitcoin ATM, with all the christmas lights.

If that doesn't work for you, message me on Slack and we can find a better time.

Realistically, I'm down here all the time, so feel free to swing by anytime you want, so long as the green light next to my office is on :)

Make sure you fill out your Enrollment Agreement and give it to me or @dannywalsh on Slack! That way we can give you a keycard so you can access Spark whenever you want.
...
If you're really _really_ itching for a challenge, go check out <https://www.stockfighter.io/>. If you'd like recommendations for other wargames to try, we can do that too.
...
Wow! That's a lot. The key takeaway here is that **there's a computer out there on the internet that sends us files whenever we want to view a site.**
...
-   Complete and turn in your Enrollment Agreement
