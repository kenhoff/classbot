...
**Heads up** - we have a little less time to complete the class this year, because we don't want to conflict with CU finals. We also don't have class during Fall Break. This means that it'd be good for us to have 2 make-up sessions at some point during the semester. More info on that later.
