...
You'll need at least 2 pages - a main page which shows all the posts in the Social Network (the news feed), and a page that lets you post to the Social Network.
